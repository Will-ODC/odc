...
- **T5 is being delivered in slices, not one PR.** At 2232 counted lines it was
  ...
  - **T5g — framing, `--head`, Stage B and precedence vectors** (2026-07-27,
    ...
    #28 had taken `042`. **Review fixes are PR #31** (below); `README.md` → v4.
...
**T5 IS COMPLETE.** T5g merged (#30) and its review fixes are in **PR #31**,
green and open as of this write. Master carries **70 vectors** (VALID 7,
PARTIAL 4, INVALID 59) and 88/88 tests. `wip/T5fg-material` is now spent and can
be deleted.
