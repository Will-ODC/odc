...
checklist, then read the diff once more top-to-bottom. Verdict: APPROVE or
BLOCK with numbered findings, each tied to a rule, contract clause, or charter
principle. Boundary violations (cross-service table reads, UPDATE/DELETE on
